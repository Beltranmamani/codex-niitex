...
<head>
    ...
    <title><?=SISTEMA_NOMBRE;?> - Creditos por proveedor</title>
...
<body class="alt-menu sidebar-noneoverflow">
                                ...
                                <div class="row" style="padding: 15px;">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control  basic" id="proveedor">
    ...
    <script>
        $(document).ready(function(){
            $("#view_compras, #vista_credito_proveedor, #dp_creditos").addClass("active");
            ...
            c2 = $('#table_compras').DataTable({
                ...
                buttons: {
                    buttons: [
                        { 
                            ...
                            extend: 'pdfHtml5', 
                            title : "REPORTE DE CREDITOS POR PROVEEDOR - <?=$_SESSION["nombre_sucursal"]?> - <?=date('Y-m-d H:i:s')?>",
                            className: 'btn',
                ...
                "oLanguage": {
                    ...
                    "sZeroRecords": "No hay coincidencias de creditos por proveedor, seleccione un rango...",
            ...
            if(proveedor == null){
                ...
                if(fecha_1.length <1 || fecha_2.length <1){
                    ...
                    if(fecha_2<fecha_1 || fecha_1>fecha_2){
                        ...
                        $.post("<?=SERVERURL;?>compras/reporte_creditos_proveedor/",{proveedor,sucursal,fecha_1,fecha_2},function(response){            
                            if(response == 0){
                                Snackbar.show({
