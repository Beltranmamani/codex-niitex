...
/* ----------------------- Bloque de datos de empresa ----------------------- */
    ...
    $pdf->SetDrawColor(3,3,3);
    $pdf->SetLineWidth(.1);
    $pdf->RoundedRect(10, 32, 190, 25, '1.5', '');
...
/* ========================================================================== */
    ...
    $pdf->SetDrawColor(3,3,3);
    $pdf->SetLineWidth(.1);
    $pdf->RoundedRect(10, 60, 190, 38, '0', '');
    ...
    $pdf->Cell(55, 5,utf8_decode("DESCRIPCIÓN DE PRODUCTO"), 1, 0, 'C', True);
    $pdf->Cell(22, 5,utf8_decode("LINEA"), 1, 0, 'C', True);
    $pdf->Cell(30, 5,utf8_decode("PRESENTACION"), 1, 0, 'C', True);
    $pdf->Cell(22, 5,utf8_decode("STOCK ACTUAL"), 1, 0, 'C', True);
    $pdf->Cell(22, 5,utf8_decode("STOCK NUEVO"), 1, 0, 'C', True);
    $pdf->Cell(31, 5,utf8_decode("LOTE"), 1, 1, 'C', True);
...
/* ========================================================================== */
    ...
    $pdf->SetDrawColor(3,3,3);
    $pdf->SetLineWidth(.1);
    $pdf->RoundedRect(10, 100, 190, 30, '1.5', '');
