<?php
    ...
    $nombre_pagina = "Pedidos con envio Pendiente";
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title><?=SISTEMA_NOMBRE?> - Pedidos con envio Pendiente</title>
...
<body class="alt-menu sidebar-noneoverflow">
    ...
    <script>
        $(document).ready(function() {
            $("#view_tienda, #vista_pedido_ependiente").addClass("active");
            App.init();
                    ...
                    buttons: {
                        buttons: [
                            { 
                                ...
                                extend: 'pdfHtml5', 
                                title : "REPORTE DE PEDIDOS CON ENVIO PENDIENTE - <?=$_SESSION["nombre_sucursal"]?> - <?=date('Y-m-d H:i:s')?>",
                                className: 'btn',
