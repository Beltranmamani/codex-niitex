...
<head>
    ...
    <title><?=SISTEMA_NOMBRE;?> - Arqueos por fecha </title>
                                        ...
                                        <div class="widget-content widget-content-area underline-content">
                                            <table id='table_compras' class="table">
                                                <thead class='bg-primary'>
                                                    <tr>
                                                        <th class='text-white'>FECHA APERTURA</th>
                                                        <th class='text-white'>CAJA</th>
                                                        <th class='text-white'>VENDEDOR</th>
                                                        <th class='text-white'>FECHA CIERRE</th>
                                                        <th class='text-white'>INICIAL</th>
                                                        <th class='text-white'>INGRESOS</th>
                                                        <th class='text-white'>EGRESOS</th>
                                                        <th class='text-white'>CREDITOS</th>
                                                        <th class='text-white'>ABONOS</th>
                                                        <th class='text-white'>DINERO EFECTIVO</th>
...
/* ========================================================================== */
        ...
        $(document).ready(function(){
            ...
            multiCheck(c2);
            $("#view_caja, #vista_arqueos_por_fecha,#dp_reporte_caja").addClass("active");
        ...
        $("#btn_consultar").click(function(){
            ...
            if(fecha_1.length <1 || fecha_2.length <1){
                ...
                if(fecha_2<fecha_1 || fecha_1>fecha_2){
                    ...
                    $.post("<?=SERVERURL;?>caja/arqueos_por_fecha/",{fecha_1,fecha_2,sucursal},function(response){
                        if(response == 0 || response == ""){
                            Snackbar.show({
                                text: 'No hay arqueos disponibles en ese rango de fechas',
                                actionTextColor: '#fff',
                                ...
                                buttons: {
                                    buttons: [
                                        { 
                                            ...
                                            extend: 'pdfHtml5', 
                                            title : "REPORTE DE ARQUEOS - <?=$_SESSION["nombre_sucursal"]?> - <?=date('Y-m-d H:i:s')?>",
                                            className: 'btn',
                                            orientation :'landscape',
                                            pageSize:'A4',
                                            exportOptions: {
                                ...
                                initComplete: function () {
                                    ...
                                    $(".thead2", api.table().header()).each(function (i) {
                                        ...
                                        $("#" + title).select2({
                                            multiple: true,
                                            closeOnSelect: false,
                                            placeholder: "Seleccionar a " + title,
                                        });
