<?php
    ...
    $nombre_pagina = "Estado de producto";
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title><?=SISTEMA_NOMBRE?> - Estado de producto</title>
...
<body class="alt-menu sidebar-noneoverflow">
                    ...
                    <div class="col-12 layout-spacing">
                        <div class="widget-four card p-2" id='card'>
                            ...
                            <div class="widget-content ">
                                <div class=" mb-4 mt-2 table-responsive" id="table-card">
                                    <table id="tb_compras" class="table table-responsive style-2 ">
        ...
        <div class="modal-dialog modal-xl">
            ...
            <div class="modal-content"  id='loader_detail' style="zoom: 1;">
                ...
                <div class="modal-body">
                    ...
                    <div class=" mt-3">
                        <table class=" table-responsive table table-bordered table-striped mb-4">
                            <thead class="bg-primary">
                                <tr>
    ...
    <script>
        $(document).ready(function() {
            $("#view_tienda, #vista_estado_productos").addClass("active");
            App.init();
        ...
        let lista_pedidos = ()=>{
            ...
            $.post("<?=SERVERURL?>pedidostienda/estado_productos_pedido/",{token},function(res){
                    ...
                    buttons: {
                        buttons: [
                            { 
                                ...
                                extend: 'pdfHtml5', 
                                title : "ESTADO DE PRODUCTOS - <?=$_SESSION["nombre_sucursal"]?> - <?=date('Y-m-d H:i:s')?>",
                                className: 'btn',
        ...
        $(document).on('click','#btn_consultar',function(){
            ...
            if(fecha_1.length <1 || fecha_2.length <1){
                ...
                if(fecha_2<fecha_1 || fecha_1>fecha_2){
                    ...
                    $.post("<?=SERVERURL;?>pedidostienda/estado_productos_pedido_fecha/",{fecha_1,fecha_2},function(response){
                        let table = $('#tb_compras').DataTable();
                        table.destroy();
