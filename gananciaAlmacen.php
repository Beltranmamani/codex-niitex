...
<head>
    ...
    <title><?=SISTEMA_NOMBRE?> - Ganancia e Inversion por Almacen</title>
            ...
            <div class="layout-px-spacing">
                ...
                <div class="page-header">
                    <div class="page-title">
                        <h3> Ganancia e Inversion por Almacen</h3>
                    </div>
                </div>
...
/* ========================================================================== */
        ...
        $(document).on('click','#btn_consultar',function(){
            ...
            $.post('<?=SERVERURL;?>almacen/lista_productos_almacen_2/',{almacen},function(response){
                if(response == 0){
                    Snackbar.show({
