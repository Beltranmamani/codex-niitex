            ...
            <div class="col-lg-8">
                        <div class="ps-section__right">
                            <div class="ps-section--account-setting">
                                ...
                                ?>
                                    <h3>#<?=$pedido["ID_INVOICE"]?> - <strong><?=$estado?></strong></h3>
                                </div>
                                <div class="ps-section__content">
                                    <div class="row">
                                        <div class="col-md-4 col-12">
                                            <figure class="ps-block--invoice">
                                                <figcaption>Datos del Pedido</figcaption>
                                                <div class="ps-block__content"><strong><?=$pedido["NOMBRE"]?></strong>
                                                    <p>Dirección de envio: <?=$pedido["DIRECCION"]?>, <?=$pedido["PROVINCIA"]?>, <?=$pedido["DEPARTAMENTO"]?></p>
                                        ...
                                        <div class="col-md-4 col-12">
                                            <figure class="ps-block--invoice">
                                                <figcaption>Monto de Envio</figcaption>
                                                <div class="ps-block__content">
                                                    <p>Envio : <?=$this->moneda?> <?=$pedido["TARIFA"]?></p>
                                                </div>
                                            </figure>
                                        </div>
                                        <div class="col-md-4 col-12">
                                            <figure class="ps-block--invoice">
                                                <figcaption>Metodo de Pago</figcaption>
                                                <div class="ps-block__content">
                                                    <p> <?php
                                                    if($pedido["PAGO"]==1){
                                                      echo "Deposito a cuenta bancaria";
                                                    }else if($pedido["PAGO"]==2){
                                                      echo "Paypal";
                                                    }
                                                    ?></p>
                                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table ps-table">
                                            ...
                                            <tbody>
                                                <?php
                                                    $producto = $this->productos_pedido;
                                                    if($producto){
                                                            ...
                                                            echo "<tr>
                                                                    <td>
                                                                        <div class='ps-product--cart'>
                                                                            <div class='ps-product__thumbnail'><a href='#'><img src='".SERVERURL."archives/assets/productos/{$p["IMAGEN"]}' alt=''></a></div>
                                                                            <div class='ps-product__content'><a href='#'>{$p["ARTICULO"]}</a>
                                                                                <p>Marca:<strong> {$p["LINEA"]}</strong></p>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    <td><span><i>{$this->moneda}</i> {$p["PRECIO"]}</span></td>
                                                                    <td>{$p["CANTIDAD"]}</td>
                                                                    <td><span><i>{$this->moneda}</i> $total</span></td>
                                                                </tr>
                                                                ";
                                                        }
                                                    }
                                ...
                                <div class="ps-section__footer">
                                  <a class="ps-btn ps-btn--sm" href="<?=SERVERURL?>tienda/pedidos/">Regresar a los pedidos</a>
                                </div>
                            </div>
                        </div>
                    </div>
