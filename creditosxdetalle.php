...
<head>
    ...
    <title><?=SISTEMA_NOMBRE;?> - Creditos por detalle</title>
...
<body class="alt-menu sidebar-noneoverflow">
    ...
    <script>
        $(document).ready(function(){
            $("#view_compras,#dp_creditos, #vista_credito_detalle").addClass("active");
                ...
                buttons: {
                    buttons: [
                        { 
                            ...
                            extend: 'pdfHtml5', 
                            title : "REPORTE DE CREDITOS POR DETALLE - <?=$_SESSION["nombre_sucursal"]?> - <?=date('Y-m-d H:i:s')?>",
                            className: 'btn',
        ...
        $(document).on('click','#btn_consultar',function(){
            ...
            if(fecha_1.length <1 || fecha_2.length <1){
                ...
                if(fecha_2<fecha_1 || fecha_1>fecha_2){
                    ...
                    $.post("<?=SERVERURL;?>compras/reporte_creditos_detalle/",{sucursal,fecha_1,fecha_2},function(response){            
                        if(response == 0){
                            Snackbar.show({
