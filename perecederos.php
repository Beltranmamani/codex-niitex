...
<head>
    ...
    <title><?=SISTEMA_NOMBRE?> - Productos en Perecederos</title>
    ...
    <script>
        ...
        */
        let mytable = function(){
            ...
            let token = "Listar_perecederos";
            $.post('<?=SERVERURL;?>inventario/lista_de_perecederos/',{token},function(response){
                if(response == 0){
                    Snackbar.show({
                        text: 'No hay perecederos productos disponibles',
                        actionTextColor: '#fff',
