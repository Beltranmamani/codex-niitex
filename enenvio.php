<?php
    ...
    $nombre_pagina = "Pedidos en Envio";
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title><?=SISTEMA_NOMBRE?> - Pedidos en Envio</title>
...
<body class="alt-menu sidebar-noneoverflow">
    ...
    <script>
        $(document).ready(function() {
            $("#view_tienda, #vista_pedido_enenvio").addClass("active");
            App.init();
                    ...
                    buttons: {
                        buttons: [
                            { 
                                ...
                                extend: 'pdfHtml5', 
                                title : "REPORTE DE PEDIDOS EN ENVIO - <?=$_SESSION["nombre_sucursal"]?> - <?=date('Y-m-d H:i:s')?>",
                                className: 'btn',
