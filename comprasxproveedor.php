...
<head>
    ...
    <title><?=SISTEMA_NOMBRE;?> - Compras por proveedor</title>
...
<body class="alt-menu sidebar-noneoverflow">
    ...
    <script>
        $(document).ready(function(){
            $("#view_compras, #vista_proveedor,#dp_compras").addClass("active");
            ...
            if(proveedor == null){
                ...
                if(fecha_1.length <1 || fecha_2.length <1){
                    ...
                    if(fecha_2<fecha_1 || fecha_1>fecha_2){
                        ...
                        $.post("<?=SERVERURL;?>compras/lista_compras_proveedor/",{proveedor,sucursal,fecha_1,fecha_2},function(response){            
                            if(response == 0){
                                Snackbar.show({
            ...
            $.post("<?=SERVERURL?>compras/detallecompra/",{id},function(response){
                if(response == 0){
                    ...
                    if(resd[0]== 1){
                        ...
                        Snackbar.show({
                            text: 'Hubo un problema, al procesar la petici��n',
                            actionTextColor: '#fff',
                            backgroundColor: '#e7515a',
                            pos: 'top-right'
                        });
