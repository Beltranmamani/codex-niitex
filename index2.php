...
<head>
    ...
    <title><?=SISTEMA_NOMBRE;?> - Kardex de productos</title>
...
<body class="alt-menu sidebar-noneoverflow">
    ...
    <script>
        $(document).ready(function(){
            $("#view_kardex, #view_kardex_productos").addClass("active");
...
/* ========================================================================== */
        ...
        $("#producto").change(function(){
            ...
            $.post("<?=SERVERURL;?>kardex/lista_entrada_salida_stock_producto_2/",{producto,sucursal},function(response){            
                if(response == 0){
                        ...
                        buttons: {
                            buttons: [
                                { 
                                    ...
                                    extend: 'pdfHtml5', 
                                    title : "REPORTE DE MOVIMIENTOS POR PRODUCTO - <?=$_SESSION["nombre_sucursal"]?> - <?=date('Y-m-d H:i:s')?>",
                                    className: 'btn',
                                    orientation :'landscape',
                                    pageSize:'A4',
                                    exportOptions: {
