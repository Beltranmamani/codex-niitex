                                ...
                                <section>
                                    <div class="form-row">
                                        <div class="col-xl-8 col-md-12 mb-4">
                                            ...
                                            <input type="text" name="nombre_sucursal" class="form-control" maxlength="100" id="nombre_sucursal" required>
                                        </div>
                                        ...
                                        <div class="col-xl-3 col-md-12 mb-4">
                                            ...
                                            <input type="text" name="numero_doc" class="form-control" maxlength="15" minlength="10" id="numero_doc" required>
                                        </div>
                                        <div class="col-xl-2 col-md-12 mb-4">
                                            <label for="iva">IVA %</label>
                                            <input type="text" name="iva" class="form-control" id="iva" required>
                                        </div>
                                        <div class="col-xl-2 col-md-12 mb-4">
                                            <label for="moneda">Moneda</label>
                                            <input type="text" name="moneda" class="form-control" maxlength="20" id="moneda" required>
                                        </div>
                                        <div class="col-xl-5 col-md-12 mb-4">
                                            <label for="email">Email</label>
                                            <input type="text" name="email" class="form-control" id="email" maxlength="51" required>
                                        </div>
                                        <div class="col-xl-3 col-md-12 mb-4">
                                            <label for="telefono">Teléfono</label>
                                            <input type="text" name="telefono" class="form-control" id="telefono" maxlength="20" required>
                                        </div>
                                        <div class="col-xl-9 col-md-12 mb-4">
                                            <label for="direccion">Dirección</label>
                                            <input type="text" name="direccion" class="form-control" id="direccion" maxlength="100" required>
                                        </div>
                                        <div class="col-xl-9 col-md-12 mb-4">
                                            <label for="representante">Representante</label>
                                            <input type="text" name="representante" class="form-control" maxlength="150" id="representante" required>
                                        </div>
        ...
        form.steps({
            ...
            onFinished:function(event,currentIndex){
                if(document.getElementById('file').files.length == 0){
                    ...
                    $.ajax({
                        url: "<?=SERVERURL;?>sucursal/guardarsucursal/",
                        type: "post",
                        data : Form,
                        processData: false,
                        contentType: false,
                        success: function(data)
                        {
                            if(data == 1){
                                ...
                                location.href = "<?=SERVERURL?>sucursal/";
                            }else if(data==2){
                                Snackbar.show({
                                    text: 'Ya existe la sucursal',
                                    actionTextColor: '#fff',
                                    backgroundColor: '#e7515a',
                                    pos: 'top-right'
                                });
