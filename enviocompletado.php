<?php
    ...
    $nombre_pagina = "Pedidos Completado";
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title><?=SISTEMA_NOMBRE?> - Pedidos Completados</title>
...
<body class="alt-menu sidebar-noneoverflow">
    ...
    <script>
        $(document).ready(function() {
            $("#view_tienda, #vista_pedido_completado").addClass("active");
            App.init();
                    ...
                    buttons: {
                        buttons: [
                            { 
                                ...
                                extend: 'pdfHtml5', 
                                title : "REPORTE DE PEDIDOS COMPLETADOS - <?=$_SESSION["nombre_sucursal"]?> - <?=date('Y-m-d H:i:s')?>",
                                className: 'btn',
