...
<head>
    ...
    <title><?=SISTEMA_NOMBRE;?> - Productos cotizados </title>
...
/* ========================================================================== */
        ...
        $(document).ready(function(){
            ...
            multiCheck(c2);
            $("#view_cotizacion, #vista_productos_cotizados,#dp_reporte_cotizacion").addClass("active");
        ...
        $("#btn_consultar").click(function(){
            ...
            if(fecha_1.length <1 || fecha_2.length <1){
                ...
                if(fecha_2<fecha_1 || fecha_1>fecha_2){
                    ...
                    $.post("<?=SERVERURL;?>cotizacion/productos_cotizados_2/",{fecha_1,fecha_2,sucursal},function(response){
