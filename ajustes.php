...
<head>
    ...
    <title><?=SISTEMA_NOMBRE?> - Ajustes de inventario</title>
...
<body class="alt-menu sidebar-noneoverflow">
            ...
            <div class="layout-px-spacing">
                ...
                <div class="page-header">
                    <div class="page-title">
                        <h3> Ajustes de stock en <?=$this->nombrealmacen?></h3>
                    </div>
                </div>
    ...
    <script>
        ...
        let mytable = function(){
            ...
            $.post('<?=SERVERURL;?>almacen/lista_productos_stock/',{almacen},function(response){
                if(response == 0){
                    Snackbar.show({
