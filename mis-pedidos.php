                    ...
                    <div class="col-12" >
                        <div class="page-header mb-3">
                            <div class="page-title">
                                <h3> Consulta de Pedidos de traspasos Solicitados</h3>
                            </div>
                        </div>
                        <div class="statbox widget box box-shadow" id="card">
                            <div class="widget-content widget-content-area">
                                <div class="row" style="padding: 15px;">
                                    ...
                                    <div class="col-sm-2">
                                        <button class="btn btn-dark mb-2 w-100" id="btn_consultar" style="height: 45px;width: 45px;">
...
/* ========================================================================== */
        ...
        let mytable = function(){
            ...
            $.post("<?=SERVERURL;?>inventario/lista_pedidotraspasos/",{sucursal},function(response){
                if(response == 0){
                    Snackbar.show({
        ...
        $("#btn_consultar").click(function(){
            ...
            if(fecha_1.length <1 || fecha_2.length <1){
                ...
                if(fecha_2<fecha_1 || fecha_1>fecha_2){
                    ...
                    $.post("<?=SERVERURL;?>inventario/lista_pedidotraspasos_fecha/",{fecha_1,fecha_2,sucursal},function(response){
                        if(response == 0){
                            Snackbar.show({
