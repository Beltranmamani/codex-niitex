...
<head>
    ...
    <title><?=SISTEMA_NOMBRE;?> - Cotizaciones por fecha </title>
        ...
        $(document).ready(function(){
            ...
            c2 = $('#table_compras').DataTable({
                ...
                "oLanguage": {
                    ...
                    "sZeroRecords": "No hay registros de cotizaciones, seleccione un rango de fechas.",
            ...
            $("#view_cotizacion, #vista_cotizaciones_fecha,#dp_reporte_cotizacion").addClass("active");
        ...
        $("#btn_consultar").click(function(){
            ...
            if(fecha_1.length <1 || fecha_2.length <1){
                ...
                if(fecha_2<fecha_1 || fecha_1>fecha_2){
                    ...
                    $.post("<?=SERVERURL;?>cotizacion/reporte_cotizaciones_fecha/",{fecha_1,fecha_2,sucursal},function(response){
                        if(response == 0){
                            Snackbar.show({
