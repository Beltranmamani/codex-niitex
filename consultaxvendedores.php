...
<head>
    ...
    <title><?=SISTEMA_NOMBRE;?> - Preventa por vendedores </title>
        ...
        $("#btn_consultar").click(function(){
            ...
            if(fecha_1.length <1 || fecha_2.length <1){
                ...
                if(fecha_2<fecha_1 || fecha_1>fecha_2){
                    ...
                    $.post("<?=SERVERURL;?>preventa/productos_preventas_vendededores/",{fecha_1,fecha_2,sucursal},function(response){
