                                    ...
                                    <table id="style-2" class="table">
                                        <thead class="bg-primary">
                                            <tr>
                                                ...
                                                <th class='text-white'>P.1</th>
                                                <th class='text-white'>P.2</th>
                                                <th class='text-white'>P.3</th>
                                                <th class='text-white'>P.4</th>
                                                <th class='text-white'>S.1</th>
                                                <th class='text-white'>S.2</th>
												<th class='text-white'>S.3</th>
												<th class='text-white'>S.4</th>
												<th class='text-white'>S.Total</th>   					
                                            </tr>
                                            <tr>
                                                <th class='thead2'></th>
                                                <th class='thead2'></th>
                                                <th class='thead2'></th> <!-- <th class="thead2 filterhead"></th>  AQUI ES PARA QUE LA MARCA SE PUEDA FILTRAR POR MARCA-->
                                                <th class='thead2'></th>
                                                <th class='thead2'></th> <!-- <th class="thead2 filterhead"></th>  AQUI ES PARA QUE LA MARCA SE PUEDA FILTRAR POR MARCA-->
                                                <th class='thead2'></th> <!-- <th class="thead2 filterhead"></th>  AQUI ES PARA QUE LA MARCA SE PUEDA FILTRAR POR MARCA-->
                                                <th class='thead2'></th>
                    ...
                    c2 = $('#style-2').DataTable({
                        ...
                        "footerCallback": function ( row, data, start, end, display ) {
                            ...
                            while(j < n_columnas){ 	
								...
								// Conversion a las nuevas medidas del stock
								total_filtro2[j] = 0;
								if ( (j >= 12) && (j <= 15) && ( total_filtro2[j] == 0 ) ) {
								    // Ajuste para eliminar la representacion de la medida del stock
									posicion_divisor = b.indexOf("/");
									if (posicion_divisor > 0 ) b = b.substr(0, posicion_divisor);
									total_filtro2[j] = b;		
									}
								////////////////////////////////////////////
                            ...
                            //Actualizar Footer
								if ( !isNaN(total_filtro) )	{
									$( api.column( j ).footer() ).html(total_filtro);
									if ( (j == 16) ) total_producto = total_filtro; 
								}
								if ( isNaN(total_filtro) ) 	$( api.column( j ).footer() ).html("");								
    						...
    						j = 12;
    						while(j <= 15){
    							total_columna = $( api.column( j ).footer() ).val();
    							if (total_filtro2[j] != 0 ) $( api.column( j ).footer() ).html( (total_producto/total_filtro2[j]).toFixed(2) );
    							j++;				
    						}
    						////////////////////////////////////////////
