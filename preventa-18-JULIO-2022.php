            ...
            if(isset($_POST["cliente"])){
                ...
                if($guardar_preventa){
                    ...
                    for($i=0;$i<$n_productos;$i++){
                        ...
                        $guardar_detalle = $this->model->agregar_detalle_preventa($id_detalle,$codigo_preventa,$p_id_item,$id_producto,$precio_1,$precio_2,$precio_3,$precio_4,$cantidad,$descuento_producto,$descuento_produc,$sub_total_producto,$total_producto,$fecha_registro, 1 );
                        if(!$guardar_detalle){
                            echo 2;
                        }
                    }
