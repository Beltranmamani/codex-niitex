<?php
    ...
    $cotizacion_informacion = $this->detalle_cotizacion;
...
<head>
    ...
    <title><?=SISTEMA_NOMBRE;?> - Procesar a Venta </title>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-xl-3 col-lg-5 col-md-5 col-sm-4 text-sm-right text-center layout-spacing align-self-center">
                                    <div class="d-flex justify-content-sm-end justify-content-center">
                                        <button type="button" class="btn btn-lg btn-warning" id="btn_productos">
                    ...
                    <div class="col-xl-4 col-12 layout-spacing">
                        <div class="widget widget-card-four_2">
                            <div class="widget-content">
                                <div class="row p-4">
                                    <div class="col-sm-12">
                                        <button class="btn btn-danger w-100 mb-2 p-3 bs-tooltip" data-toggle="tooltip" data-html="true" title="Cualquier modificación ha esta cotizacion, obligatoriamente debe ser sincronizada." onclick="sincronizar_cotizacion()">
                                    ...
                                    <div class="col-sm-6 pt-2" style="border: 1px dashed #2196F3;border-radius: 6px;">
                                        <div class="w-content">
                                            <div class="w-info mb-2">
                                                <h6 class="value"><span><?=$_SESSION["moneda"]?></span><span id="suma_price"><?=$cotizacion_informacion["SUMAS"]?></span></<h6>
                                                <p class="">SUMAS</p>
                                            </div>
                                            <div class="">
                                                <div class="w-icon">
                                    ...
                                    <div class="col-sm-6 pt-2" style="border: 1px dashed #2196F3;border-radius: 6px;">
                                        <div class="w-content">
                                            <div class="w-info mb-2">
                                                <h6 class="value"><span><?=$_SESSION["moneda"]?></span><span id="cant_iva"><?=$cotizacion_informacion["IVA"]?></span></<h6>
                                                <p class="">IVA%</p>
                                            </div>
                                            <div class="">
                                                <div class="w-icon">
                                    ...
                                    <div class="col-sm-6 pt-2" style="border: 1px dashed #2196F3;border-radius: 6px;">
                                        <div class="w-content">
                                            <div class="w-info mb-2">
                                                <h6 class="value"><span><?=$_SESSION["moneda"]?></span><span id="sub_total_price"><?=$cotizacion_informacion["SUBTOTAL"]?></span></<h6>
                                                <p class="">SUBTOTAL</p>
                                            </div>
                                            <div class="">
                                                <div class="w-icon">
                                    ...
                                    <div class="col-sm-6 pt-2" style="border: 1px dashed #2196F3;border-radius: 6px;">
                                        <div class="w-content">
                                            <div class="w-info mb-2">
                                                <h6 class="value"><span><?=$_SESSION["moneda"]?></span><span id="retencion_price"><?=$cotizacion_informacion["RETENIDO"]?></span></<h6>
                                                <p class="">RET. 1%(-)</p>
                                            </div>
                                            <div class="">
                                                <div class="w-icon">
                                    ...
                                    <div class="col-sm-6 pt-2" style="border: 1px dashed #2196F3;border-radius: 6px;">
                                        <div class="w-content">
                                            <div class="w-info mb-2">
                                                <h6 class="value"><span><?=$_SESSION["moneda"]?></span><span id="exento_price"><?=$cotizacion_informacion["EXENTO"]?></span></<h6>
                                                <p class="">EXENTO</p>
                                            </div>
                                            <div class="">
                                                <div class="w-icon">
                                    ...
                                    <div class="col-sm-6 pt-2" style="border: 1px dashed #2196F3;border-radius: 6px;">
                                        <div class="w-content">
                                            <div class="w-info mb-2">
                                                <h6 class="value"><span id="n_exento"><?=$cotizacion_informacion["PROD_EXENTOS"]?></span></<h6>
                                    ...
                                    <div class="col-sm-6 pt-2" style="border: 1px dashed #2196F3;border-radius: 6px;">
                                        <div class="w-content mb-2">
                                            <div class="w-info">
                                                <h6 class="value"><span><?=$_SESSION["moneda"]?></span><span id="precio_descuento"><?=$cotizacion_informacion["DESCUENTO"]?></span></<h6>
                                                <p class="">DESCUENTO</p>
                                            </div>
                                            <div class="">
                                                <div class="w-icon">
                                    ...
                                    <div class="col-sm-6 pt-2" style="border: 1px dashed #2196F3;border-radius: 6px;">
                                        <div class="w-content mb-2">
                                            <div class="w-info">
                                                <h6 class="value"><span><?=$_SESSION["moneda"]?></span><span id="total_price"><?=$cotizacion_informacion["TOTAL"]?></span></<h6>
                                                <p class="">TOTAL</p>
                                            </div>
                                            <div class="">
                                                <div class="w-icon">
                                    ...
                                    <div class="col-12 mt-2">
                                        <div class="form-group almacen">
                                            ...
                                            <input type="text" name="descuento_global" class = 'touchs' value='<?=$cotizacion_informacion["DESCUENTO_PERCENT"]?>' id="descuento_global">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                            ...
                                            <div class="col-3">
                                                <div class="n-chk">
                                                    <label class="new-control new-radio new-radio-text radio-classic-info">
                                                        <input type="radio" class="new-control-input rb_precios" <?php $checked = ($cotizacion_informacion["PRECIO_RADIO"]==$i) ? "checked" : "" ; echo $checked; ?>  value='<?=$i?>'name="precios_venta">
                                    ...
                                    <div class="col-12">
                                        <button id="btn_procesar_compra" class="btn btn-success btn-block mt-3 mr-2 p-3">Procesar cotizacion</button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="Modal_extralarge_productos"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-align-justify"><line x1="21" y1="10" x2="3" y2="10"></line><line x1="21" y1="6" x2="3" y2="6"></line><line x1="21" y1="14" x2="3" y2="14"></line><line x1="21" y1="18" x2="3" y2="18"></line></svg>
                ...
                <div class="text-center">
                    <div class="btn-group mb-4" role="group" aria-label="Basic example">
                       ...
                       <a id="formato_qr" href="#" target='_blank' class="btn btn-info">
                        ...
                        <a href="<?=SERVERURL?>cotizacion/consultacotizacion/" class="btn btn-success" >
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-12">
                            <div class="form-group">
                                <label for="id_cliente_venta">Codigo Cliente</label>
                                <input type="text" disabled class="form-control form-control-sm" value="<?=$datos_cliente["ID_CLIENTE"]?>" id="id_cliente_venta">
                            </div>
                        </div>
                        <div class="col-sm-6 col-12">
                            <div class="form-group">
                                <label for="limite_credito_venta">Limite crediticio</label>
                                <input type="text" class="form-control form-control-sm" value="<?=$datos_cliente["LIMITE_CREDITICIO"]?>" id="limite_credito_venta" value="0.00" disabled>
                        ...
                        <div class="col-sm-12 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" disabled id="cliente" value="<?php echo strtoupper($datos_cliente["RAZON"])." | ".strtoupper($datos_cliente["DOCUMENTO"])." ".strtoupper($datos_cliente["N_DOCUMENTO"]);?>">
                            </div>
                        </div>
                           <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                        <label for="id_cliente_venta">Limite de creditos</label>
                                        <input type="text" class="form-control form-control-sm" id="id_cliente_creditolimite_venta" readonly="readonly" value="<?=$datos_cliente["N_CREDITO"]?>">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                        <label for="id_cliente_venta">Creditos activo</label>
                                        
                                        <input type="text" class="form-control form-control-sm" id="id_cliente_creditos_venta" readonly="readonly" value="<?=$datos_cliente["CREDITOS"]?>">
                                    </div>
                                </div>
                        <div class="col-sm-6 col-12">
                            <div class="form-group">
                                <label for="tipo_pago">Tipo de pago</label>
                                <select class="form-control  basic" id="tipo_pago">
                        ...
                        <div class="col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <select class="form-control  basic " id="tipo_comprobante">
                        ...
                        <div class="col-sm-6 col-12 " >
                            <div class="form-group">
                                ...
                                <select class="form-control  basic" id="metodo_pago">
                                    <option value="1" selected>EFECTIVO</option>
                                    <option value="2">TARJETA DE DEBITO/CREDITO</option>
                                    <option value="3">EFECTIVO Y TARJETA</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-sm-6 col-12 " id="cont_monto_a_pagar">
                            <div class="form-group">
                                <label for="monto_a_pagar">Monto a pagar(*)</label>
                                <input type="text" class="form-control form-control-sm" id="monto_a_pagar" value="" disabled>
                            </div>
                        </div>
                        <div class="col-sm-6 col-12 " id="cont_efectivo_recibido">
                            <div class="form-group">
                                <label for="efectivo_recibido" >Efectivo recibido (*)</label>
                                <input type="text" class="form-control form-control-sm efectivo" id="efectivo_recibido" value="0.00" disabled>
                            </div>
                        </div>
                        <div class="col-sm-6 col-12 " id="cont_cambio_venta">
                            <div class="form-group">
                                <label for="cambio_venta" >Cambio (*)</label>
                                <input type="text" class="form-control form-control-sm" id="cambio_venta" value="0.00"  disabled>
                            </div>
                        </div>
                        <div class="col-sm-6 col-12" id="cont_tarjeta_debito_credito">
                            <div class="form-group">
                                <label for="tarjeta_debito_credito">Tarjeta debito/credito (*)</label>
                                <input type="text" class="form-control form-control-sm" id="tarjeta_debito_credito" value="" placeholder="1220-1233-xxxx-xxxx">
                            </div>
                        </div>
                        <div class="col-sm-6 col-12"  id="cont_tarjetahabitante">
                            <div class="form-group">
                                <label for="tarjetahabitante">Tarjeta habitante (*)</label>
                                <input type="text" class="form-control form-control-sm" id="tarjetahabitante" value="" placeholder="PEDRO AQUILES">
                            </div>
                        </div>
                        <div class="col-sm-6 col-12" id="cont_monotodebitado">
                            <div class="form-group">
                                <label for="monotodebitado">Monto debitado (*)</label>
                                <input type="text" placeholder='0.00' class="form-control form-control-sm" id="monotodebitado" value="">
                            </div>
                        </div>
                        <div class="col-sm-6 col-12" id="cont_fecha_limite">
                            <div class="form-group">
                                <label for="fecha_limite">Fecha límite (*)</label>
                                <input type="date" placeholder='2020-12-08' class="form-control form-control-sm" id="fecha_limite" disabled>
                            </div>
                        </div>
                        <div class="col-sm-6 col-12 " >
                                    <div class="form-group">
                                        <label for="venta_facturar">Facturar venta</label>
                                        <select class="form-control  basic" id="venta_facturar">
                                            <option value="1" selected>FACTURAR</option>
                         ...
                         <div class="col-12 " >
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="nrofactura" value="1" >
                                </div>
                            </div>
                            
                            <div class="col-12 " >
                                <div class="form-group">
                                    <label for="nombrepromotor" >Nombre de Promotor</label>
                                    <input type="text" class="form-control form-control-sm" id="nombrepromotor" value="1">
                                </div>
                            </div>
                        <div class="col-sm-12 col-12" id="observacion_colum">
                            <div class="form-group">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id='btn_facturar'>
...
/* ========================================================================== */
        ...
        let sumarprecio_2 = function(){
            ...
            for (i = 1; i < items + 1; i++){
                ...
                var precio_radio_ITEM = $('#precio_radio_'+id_item).val();
                var precio_stock = $('#precio_stock_'+id_item).val()
                if(precio_radio_ITEM!=precio_stock){
                    $('#precio_stock_'+id_item).val(precio_radio_ITEM)
              
                    $('#precio_radio_'+id_item).val(precio_stock);
                }
                var text_stock = $("#precio_stock_"+id_item+" option:selected").text()
                $("#medida_select_"+id_item).val(text_stock)
                ...
                if(cantidad<1){
                    ...
                    var precio = $("#precio_"+precio_radio_ITEM+"_"+id_item).val();
                    if(exento==1){
                        exentos++;
                        precio = parseFloat(precio);
                        subtotal_producto = parseFloat(cantidad*precio);
                       descuento = (subtotal_producto*descuento)/100;
            ...
            if(suma>0){
                iva = parseFloat(suma*porcentajeiva);
            }
            let descuento_porcentaje = parseFloat($("#descuento_global").val());

            exentos_price = parseFloat(exentos_price)
            subtotal = suma - iva;
            retencion = 0; //subtotal-suma
            total = parseFloat(subtotal+iva+exentos_price);
        ...
        let sumarprecio = function(){
            ...
            for (i = 1; i < items + 1; i++){
                ...
                if(cantidad<1){
                    ...
                    var precio = $("#precio_"+precio_stock+"_"+id_item).val();
                    if(exento==1){
                        exentos++;
                        precio = parseFloat(precio);
                        subtotal_producto = parseFloat(cantidad*precio);
...
/* ========================================================================== */
        ...
        $(document).on('change','.pr_text',function(){
            // sumarprecio();
        })
/* ========================================================================== */
...
/* ========================================================================== */
        $("#btn_facturar").click(function(){
            ...
            let id_cliente_creditos_venta = parseInt($("#id_cliente_creditos_venta").val());
            let id_cliente_creditolimite_venta = parseInt($("#id_cliente_creditolimite_venta").val());
            ...
            if(id_cliente.length <1 || id_cliente_creditos_venta.length<1 || id_cliente_creditolimite_venta.length <1 || limite_credito_venta.length <1){
                ...
                if(tipo_comprobante == null){
                    ...
                    for (i = 1; i < items + 1; i++){
                        ...
                        let precio_radio_stock = $("#precio_stock_"+id_item).val();
                        let precio = $("#precio_"+precio_radio_stock+"_"+id_item).val();
                        ...
                        // CANTIDAD SEGUN LA MEDIDA DEL PRODUCTO COTIZADO
						let cantidad_medida_producto = $("#medida_"+precio_radio_stock+"_"+id_item).val();
                          console.log("cantidad_medida_producto: " + cantidad_medida_producto ); 
                          let medida =$('#medida_select_'+id_item).val()
                        data += id_item+'|'+almacen+'|'+cantidad+'|'+descuento+'|'+precio+'|'+descuento_producto+'|'+sub_total_producto_+'|'+total_producto+'|'+stock+'|'+producto+'|'+cantidad_medida_producto+'|'+medida+','; console.log("VALOR DE DATA_EN_COTIZACION: " + data ); //popopiohiyhir();;
                    };
                     let nrofactura = $("#nrofactura").val();
                    let nombrepromotor = $("#nombrepromotor").val();
                    $.post("<?=SERVERURL;?>cotizacion/hacer_venta/",{venta_facturar,
                    id_cotizacion,id_cliente,monto_a_pagar,efectivo_recibido,cambio,descuento_percent,
                    ...
                    tipo_comprobante,tipo_pago,metodo_pago,data,fecha_limite,observacion,precio_radio,nrofactura,nombrepromotor
                        ...
                        if(response == 3){
                            swal({
                                title: 'Cotizacion ya procesada!',
                                text: 'La cotizacion no puede ser modificada',
                                imageUrl: '<?=SERVERURL;?>archives/assets/pos/error_preventa.jpg',
                                imageWidth: 400,
                                imageHeight: 200,
                                imageAlt: 'Error cotizacion',
                                animation: false,
                                padding: '2em',
                                animation: false,
...
/* ========================================================================== */
        ...
        let cargar_producto_cotizacion = ()=>{
            let id_cotizacion = "<?=$this->id_cotizacion;?>";
            ...
            $.post("<?=SERVERURL?>cotizacion/lista_items_cotizacion/",{id_cotizacion},function(response){
...
/* ========================================================================== */
        $(document).on('change','.precio_stock',function(){
            sumarprecio();
        });
        $(document).on('click','.btn_eliminar_producto_prevendido',function(){
            ...
            swalWithBootstrapButtons({
                title: 'Estas seguro?',
                text: "Esta accion es reversible!",
                type: 'warning',
                ...
                if (result.value) {
                    $.post("<?=SERVERURL?>cotizacion/eliminar_producto_cotizacion/",{id_item,id_cotizacion,id_detalle,cantidad_prevendida},function(response){
                        if(response == 3){
                            swal({
                                title: 'Cotizacion ya procesada!',
                                text: 'La cotizacion no puede ser modificada',
                            ...
                            swalWithBootstrapButtons(
                                'No se pudo eliminar!',
                                'Debes eliminar por completo la cotizacion',
                                'success'
                            );
                        }else{
                            swalWithBootstrapButtons(
                                'Eliminado!',
                                'El producto fue quitado de cotizacion',
                                'success'
                            );
                            sincronizar_cotizacion();
                            productos_almacen();
                        }
                    });
                }else if (
...
/* ========================================================================== */
        ...
        let sincronizar_cotizacion = ()=>{
            ...
            for (i = 1; i < items + 1; i++){
                ...
                let stock = $('#items_widgets .items:nth-child('+i+')').attr('stock');
                let producto = $('#items_widgets .items:nth-child('+i+')').attr('producto');
                // CANTIDAD SEGUN LA MEDIDA DEL PRODUCTO VENDIDO
				let cantidad_medida_producto = $("#medida_"+precio_radio+"_"+id_item).val();
                let cantidad = ($("#cantidad_"+id_item).val()) * cantidad_medida_producto; console.log("VALOR DE cantidad SINCRONIZADA: " + cantidad );
                let descuento = $("#descuento_"+id_item).val();
                ...
                let precio_5 = $("#precio_5_"+id_item).val();
                let precio_6 = $("#precio_6_"+id_item).val();
                let precio_7 = $("#precio_7_"+id_item).val();
                ...
                let total_producto = $("#total_producto_"+id_item).text();
                let medida =$('#medida_select_'+id_item).val()
                data += id_item+'|'+almacen+'|'+cantidad+'|'+descuento+'|'+precio_1+'|'+precio_2+'|'+precio_3+'|'+precio_4+'|'+descuento_producto+'|'+sub_total_producto_+'|'+total_producto+'|'+stock+'|'+producto+'|'+producto_preventa+'|'+cantidad_medida_producto+'|'+medida+'|'+precio_radio_stock+'|'+precio_5+'|'+precio_6+'|'+precio_7+',' ; console.log("VALOR DE DATA EN sincronizar_cotizacion: " + data ); //detener_en_sincronizar_cotizacion();
            };
            $.post("<?=SERVERURL?>cotizacion/actualizar_cotizacion/",
                {data,id_cotizacion,suma_price,cant_iva,sub_total_price,retencion_price,
                precio_descuento,exento_price,n_exento,descuento_global,total_price,
                precio_radio},function(response){
                    if(response==1){
                        Snackbar.show({
                            text: 'Cotizacion sincronizada con exito!',
                            actionTextColor: '#fff',
