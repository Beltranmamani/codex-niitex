...
<head>
    ...
    <title><?=SISTEMA_NOMBRE;?> - Devoluciones por vendedor</title>
            ...
            if(vendedor == null){
                ...
                if(fecha_1.length <1 || fecha_2.length <1){
                    ...
                    if(fecha_2<fecha_1 || fecha_1>fecha_2){
                        ...
                        $.post("<?=SERVERURL;?>preventa/lista_preventa_vendedor_devolucion/",{vendedor,sucursal,fecha_1,fecha_2},function(response){            
