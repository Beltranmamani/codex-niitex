...
<head>
    ...
    <title><?= SISTEMA_NOMBRE; ?> - Consulta de pagos </title>
...
<body class="alt-menu sidebar-noneoverflow">
                                        ...
                                        <table id='table_compras' class="table">
                                            <thead class='bg-primary'>
                                                <tr>
                                                    ...
                                                    <th class='text-white'>Nº CREDITO</th>
                                                    <th class='text-white'>Nº COMPRA</th>
                                                    <th class='text-white'>PROVEEDOR</th>
                                                    <th class='text-white'>TOTAL CREDITO</th>
                                                    <th class='text-white'>CREDITO PENDIENTE</th>
                                                    <th class='text-white'>ABONO</th>
                                                    <th class='text-white'>PAGO CON</th>
                                                    <th class='text-white'>CAMBIO</th>
                                                    <th class='text-white'>ESTADO COMPRA</th>
    ...
    <script>
        ...
        let mytable = function() {
            ...
            $.post("<?= SERVERURL; ?>compras/lista_pagos_credito/", {
                sucursal
            }, function(response) {
        ...
        $("#btn_consultar").click(function() {
            ...
            if (fecha_1.length < 1 || fecha_2.length < 1) {
                ...
                if (fecha_2 < fecha_1 || fecha_1 > fecha_2) {
                    ...
                    $.post("<?= SERVERURL; ?>compras/lista_pagos_credito_fecha/", {
                        fecha_1,
                        fecha_2,
                        sucursal
                    }, function(response) {
