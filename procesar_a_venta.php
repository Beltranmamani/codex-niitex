                    ...
                    <div class="col-xl-4 col-12 layout-spacing">
                        <div class="widget widget-card-four_2">
                            <div class="widget-content">
                                <div class="row p-4">
                                    <div class="col-sm-12">
                                        <button class="btn btn-danger w-100 mb-2 p-3 bs-tooltip" data-toggle="tooltip" data-html="true" title="Cualquier modificación ha esta preventa, obligatoriamente debe ser sincronizada." onclick="sincronizar_preventa()">
                                    ...
                                    <div class="col-12">
                                        <button id="btn_procesar_compra" class="btn btn-success btn-block mt-3 mr-2 p-3">Procesar preventa</button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="text-center">
                    <div class="btn-group mb-4" role="group" aria-label="Basic example">
                       ...
                       <a id="formato_ticket" href="#" target='_blank' class="btn btn-info">
                         ...
                         <div class="col-sm-6 col-12 " >
                                    <div class="form-group">
                                        ...
                                        <select class="form-control  basic" id="venta_facturar">
                                            ...
                                            <option value="2" selected>NO FACTURAR</option>
                                        </select>
                                    </div>
                                </div>
                         <div class="col-12 " >
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="nrofactura" value="<?=$preventa_informacion['NRO_FACTURA']?>" >
                                </div>
                            </div>
                            <div class="col-12 " >
                                <div class="form-group">
                                    <label for="nombrepromotor" >Nombre de Promotor</label>
                                    <input type="text" class="form-control form-control-sm" id="nombrepromotor" value="<?=$preventa_informacion['NOMBRE_PROMOTOR']?>">
                                </div>
                            </div>
            ...
            if(id_cliente.length <1 || id_cliente_creditos_venta.length<1 || id_cliente_creditolimite_venta.length <1 || limite_credito_venta.length <1){
                ...
                if(tipo_comprobante == null){
                    ...
                    for (i = 1; i < items + 1; i++){
                        ...
                        data += id_item+'|'+almacen+'|'+cantidad+'|'+descuento+'|'+precio+'|'+descuento_producto+'|'+sub_total_producto_+'|'+total_producto+'|'+stock+'|'+producto+'|'+cantidad_medida_producto+','; console.log("VALOR DE DATA: " + data ); ///IUHKFHIEGHIEHIUE();
                    };
                    ...
                    tipo_comprobante,tipo_pago,metodo_pago,data,fecha_limite,observacion,precio_radio,nrofactura,nombrepromotor
                        ...
                        if(response == 3){
                            ...
                            if(resd[0]== 1){
                                ...
                                $("#formato_ticket").attr('href',"<?=SERVERURL;?>ventas/ticket/"+resd[1]);
...
/* ========================================================================== */
        ...
        $(document).on('click','.btn_eliminar_producto_prevendido',function(){
            ...
            swalWithBootstrapButtons({
                ...
                if (result.value) {
                    $.post("<?=SERVERURL?>preventa/eliminar_producto_prevendido/",{id_item,id_preventa,id_detalle,cantidad_prevendida},function(response){
                        if(response == 3){
                            swal({
                                title: 'Preventa ya procesada!',
                                text: 'La preventa no puede ser modificada',
...
/* ========================================================================== */
        ...
        let sincronizar_preventa = ()=>{
            ...
            for (i = 1; i < items + 1; i++){
				...
				// CANTIDAD SEGUN LA MEDIDA DEL PRODUCTO VENDIDO
				let cantidad_medida_producto = $("#medida_"+precio_radio+"_"+id_item).val();
                let cantidad = ($("#cantidad_"+id_item).val()) * cantidad_medida_producto; console.log("VALOR DE cantidad: " + cantidad );
                let descuento = $("#descuento_"+id_item).val();
                ...
                let sub_total_producto_ = $("#sub_total_producto_"+id_item).text();
                let total_producto = $("#total_producto_"+id_item).text();
                data += id_item+'|'+almacen+'|'+cantidad+'|'+descuento+'|'+precio_1+'|'+precio_2+'|'+precio_3+'|'+precio_4+'|'+descuento_producto+'|'+sub_total_producto_+'|'+total_producto+'|'+stock+'|'+producto+'|'+producto_preventa+'|'+cantidad_medida_producto+','; console.log("VALOR DE DATA EN sincronizar_preventa: " + data ); ///IUHKFHIEGHIEHIUE();
            };
            $.post("<?=SERVERURL?>preventa/actualizar_preventa/",
                {data,id_preventa,suma_price,cant_iva,sub_total_price,retencion_price,
