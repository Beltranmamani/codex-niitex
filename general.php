...
<head>
    ...
    <title><?=SISTEMA_NOMBRE;?> - Kardex valorizado general</title>
...
<body class="alt-menu sidebar-noneoverflow">
                    ...
                    <div class="col-12" >
                        <div class="page-header mb-3">
                            <div class="page-title">
                                <h3> Kardex valorizado por fecha </h3>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function(){
            $("#view_kardex, #view_kardex_valorizado_fecha").addClass("active");
...
let mytable = function(){
            ...
            $.post("<?=SERVERURL;?>kardex/kardex_general/",{sucursal,usuario},function(response){
                if(response == 0){
                    Snackbar.show({
        ...
        $(document).on('click','#btn_consultar',function(){
                ...
                if(fecha_1.length <1 || fecha_2.length <1){
                    ...
                    if(fecha_2<fecha_1 || fecha_1>fecha_2){
                        ...
                        $.post("<?=SERVERURL;?>kardex/kardex_valorizado_general_fecha/",{sucursal,fecha_1,fecha_2},function(response){            
                            if(response == 0){
                                Snackbar.show({
                                    text: 'No hay registros disponibles en ese rango de fechas',
                                    actionTextColor: '#fff',
                                    backgroundColor: '#e7515a',
                                    pos: 'top-right'
                                });
                                    ...
                                    buttons: {
                                        buttons: [
                                            { 
                                                ...
                                                extend: 'pdfHtml5', 
                                                title : "REPORTE DE VALORIZADO POR VENDEDORES - <?=$_SESSION["nombre_sucursal"]?> - <?=date('Y-m-d H:i:s')?>",
                                                className: 'btn',
                                                orientation :'landscape',
                                                pageSize:'A4',
                                                exportOptions: {
