...
<head>
    ...
    <title><?=SISTEMA_NOMBRE;?> - Nueva Persona </title>
                                ...
                                <section>
                                    <div class="form-row">
                                        <div class="col-xl-6 col-md-12 mb-4">
                                            ...
                                            <input type="text" name="nombre" class="form-control" maxlength="100" id="nombre" required>
                                        </div>
                                        <div class="col-xl-6 col-md-12 mb-4">
                                            <label for="apellidos">Apellidos</label>
                                            <input type="text" name="apellidos" class="form-control" maxlength="100" id="apellidos" required>
                                        </div>
    ...
    <script>
        ...
        form.steps({
            ...
            onFinished:function(event,currentIndex){
                ...
                $.ajax({
                    url: "<?=SERVERURL;?>personal/guardarpersona/",
                    type: "post",
                    data : Form,
                    processData: false,
                    contentType: false,
                    success: function(data)
                    {
                        if(data == 1){
                            ...
                            location.href = "<?=SERVERURL?>personal/personas/";
                        }else if(data==2){
                            Snackbar.show({
                                text: 'No se pudo agregar persona',
                                actionTextColor: '#fff',
                                backgroundColor: '#e7515a',
                                pos: 'top-right'
                            });
