...
<head>
    ...
    <title><?=SISTEMA_NOMBRE;?> - Compras por fecha </title>
...
<body class="alt-menu sidebar-noneoverflow">
    ...
    <script>
        $(document).ready(function(){
            $("#view_compras, #vista_compras_fecha ,#dp_compras").addClass("active");
            c2 = $('#table_compras').DataTable({
                ...
                "oLanguage": {
                    ...
                    "sZeroRecords": "No hay registros de compras, seleccione un rango de fechas.",
        ...
        $("#btn_consultar").click(function(){
            ...
            if(fecha_1.length <1 || fecha_2.length <1){
                ...
                if(fecha_2<fecha_1 || fecha_1>fecha_2){
                    ...
                    $.post("<?=SERVERURL;?>compras/reporte_compras_fecha/",{fecha_1,fecha_2,sucursal},function(response){
                        if(response == 0){
                            Snackbar.show({
