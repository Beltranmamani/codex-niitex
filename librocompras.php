...
<head>
    ...
    <title><?=SISTEMA_NOMBRE;?> - Libro de compras IVA </title>
...
<body class="alt-menu sidebar-noneoverflow">
                    ...
                    <div class="col-12" >
                        ...
                        <div class="statbox widget box box-shadow" id="card">
                            ...
                            <div class="row" style="padding: 15px;">
                                ...
                                <div class="col-sm-2">
                                    <button class="btn btn-dark mb-2 mr-2 rounded-circle" id="btn_consultar" style="height: 45px;width: 45px;">
                                ...
                                <div class="col-12 table-responsive">
                                    <table id='table_compras' class="table">
                                        <thead class='bg-primary'>
                                            <tr>
                                                <th  class='text-white'>Especificacion</th>
                                                <th  class='text-white'>No.</th>
                                                <th  class='text-white'>Fecha de Factura</th>
                                                <th  class='text-white'>NIT/CI Proveedor</th>
                                                <th  class='text-white'>Nombre/Razon Social</th>
                                                <th  class='text-white'>No. Factura</th>
                                                <th  class='text-white'>No. DUI</th>
                                                <th  class='text-white'>No. Autorizacion</th>
                                                <th  class='text-white'>Importe total de compra</th>
                                                <th  class='text-white'>Importe no Sujeto a Credito Fiscal </th>
                                                <th  class='text-white'>Sub total</th>
                                                <th  class='text-white'>Descuentos</th>
                                                <th  class='text-white'>Importe Base Credito Fiscal</th>
                                                <th  class='text-white'>Credito Fiscal</th>
                                                <th  class='text-white'>Codigo de control</th>
                                                <th  class='text-white'>Tipo de compra</th>
                                        ...
                                        <tfoot>
                                            <!--<tr>-->
                                            <!--    <th class="invisible">Comprobante</th>-->
                                            <!--    <th class="invisible">No. Comprobante</th>-->
                                            <!--    <th class="invisible">Lote</th>-->
                                            <!--    <th>Total</th>-->
                                            <!--    <th>Total</th>-->
                                            <!--    <th>Total</th>-->
                                            <!--    <th class="invisible">Tipo pago</th>-->
                                            <!--    <th class="invisible">Total</th>-->
                                            <!--    <th class="invisible">Estado</th>-->
                                            <!--    <th class="invisible">Responsable</th>-->
                                            <!--    <th class='invisible'>Opciones</th>-->
                                            <!--</tr>-->
                                        </tfoot>
                                    </table> 
                                </div>
                        ...
                        <table class="table table-bordered table-striped mb-4">
                            <thead class="bg-primary">
                                <tr>
                                    ...
                                    <th class='text-white'>Presentaci贸n</th>
    ...
    <script>
        $(document).ready(function(){
            $("#view_ventas, #vista_consulta_ventas").addClass("active");
            ...
            $.post("<?=SERVERURL;?>compras/compraivalibro/",{sucursal},function(response){
                if(response == 0){
                    Snackbar.show({
                        ...
                        buttons: {
                            buttons: [
                                { 
                                    ...
                                    extend: 'pdfHtml5', 
                                    title : "REPORTE DE LIBRO VENTAS - <?=$_SESSION["nombre_sucursal"]?> - <?=date('Y-m-d H:i:s')?>",
                                    className: 'btn',
                            ...
                            "footerCallback": function ( row, data, start, end, display ) {
                                ...
                                // $(api.column(3).footer()).html("Total <?=$_SESSION['moneda']?> ");
    ...
    <script>
        $("#btn_consultar").click(function(){
            ...
            if(fecha_1.length <1 || fecha_2.length <1){
                ...
                if(fecha_2<fecha_1 || fecha_1>fecha_2){
                    ...
                    $.post("<?=SERVERURL;?>compras/compraivalibrofecha/",{fecha_1,fecha_2,sucursal},function(response){
                        if(response == 0){
                            Snackbar.show({
                                text: 'No hay ventas disponibles en ese rango de fechas',
                                actionTextColor: '#fff',
                                backgroundColor: '#e7515a',
                                pos: 'top-right'
                            });
        ...
        $(document).on('click','.btn_detalle',function(){
            ...
            $.post("<?=SERVERURL?>ventas/detalle_venta/",{id},function(response){
                if(response == 0){
                    Snackbar.show({
                    ...
                    if(resd[0]== 1){
                        ...
                        $("#comprobante_detalle").text(resd[14]);
                        $("#nro_comprobante_detalle").text(resd[15]);
                        $.post("<?=SERVERURL?>ventas/lista_items_venta/",{id},function(respuesta){
                            if(respuesta != 0 ){
                        ...
                        Snackbar.show({
                            text: 'Hubo un problema, al procesar la petici贸n',
                            actionTextColor: '#fff',
                            backgroundColor: '#e7515a',
                            pos: 'top-right'
                        });
        ...
        $(document).on('click','.btn_anular',function(){
            ...
            let id_v = $(this).attr('id_v');
            let nro_v = $(this).attr('nro_v');
            let arqueo = $(this).attr('arqueo');
            ...
            if(estado==1 || estado == 2){
                ...
                swalWithBootstrapButtons({
                    title: 'Estas seguro?',
                    text: "Es irrevertible el cambio si anulas la venta!",
                    type: 'warning',
                    ...
                    if (result.value) {
                        $.post("<?=SERVERURL?>ventas/anular_venta/",{id_v,nro_v,arqueo,total,estado},function(response){
                            ...
                            if(response == 1){
                                ...
                                toast({
                                    type: 'error',
                                    title: 'Lo siento, no se pudo anular la venta',
                                    padding: '2em',
                                });
                            }
                            // alert(response);
                ...
                toast({
                    type: 'error',
                    title: 'Lo siento, venta ya anulada',
                    padding: '2em',
                })
            }
        });
