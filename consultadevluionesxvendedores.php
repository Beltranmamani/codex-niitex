...
<head>
    ...
    <title><?=SISTEMA_NOMBRE;?> - Devoluciones por vendedores </title>
                    ...
                    <div class="col-12" >
                        <div class="page-header mb-3">
                            <div class="page-title">
                                <h3>Devoluciones por vendedores</h3>
                            </div>
                        </div>
                                            ...
                                            <table id='table_compras' class="table">
                                                <thead class='bg-primary'>
                                                    <tr>
                                                        ...
                                                        <th class='text-white'>COD/BARRA</th>
...
/* ========================================================================== */
        ...
        $(document).ready(function(){
                ...
                buttons: {
                    buttons: [
                        { 
                            ...
                            extend: 'pdfHtml5', 
                            title : "REPORTE DE PREVENTAS POR VENDEDORES - <?=$_SESSION["nombre_sucursal"]?> - <?=date('Y-m-d H:i:s')?>",
                            className: 'btn',
            ...
            multiCheck(c2);
            $("#view_preventa, #vista_prventaxvendedores,#dp_reporte_preventa").addClass("active");
        ...
        $("#btn_consultar").click(function(){
            ...
            if(fecha_1.length <1 || fecha_2.length <1){
                ...
                if(fecha_2<fecha_1 || fecha_1>fecha_2){
                    ...
                    $.post("<?=SERVERURL;?>preventa/productos_preventas_vendededores_devoluciones/",{fecha_1,fecha_2,sucursal},function(response){
                                ...
                                buttons: {
                                    buttons: [
                                        { 
                                            ...
                                            extend: 'pdfHtml5', 
                                            title : "REPORTE DE DEVOLUCIONES POR VENDEDORES - <?=$_SESSION["nombre_sucursal"]?> - <?=date('Y-m-d H:i:s')?>",
                                            className: 'btn',
                                            orientation :'landscape',
                                            pageSize:'A4',
                                            exportOptions: {
