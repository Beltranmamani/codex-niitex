...
<html lang="es">
  <head>
    ...
    <title><?=SISTEMA_NOMBRE?> - Perfil</title>
          ...
          <div class="row">
            <div class="col-lg-4">
              <div class="ps-section__left">
                  <aside class="ps-widget--account-dashboard">
                    <div class="ps-widget__header" id="card_cliente">
                      <img src="<?=SERVERURL?>archives/avatars/<?=$cliente["PERFIL"]?>" alt="">
                      <figure>
                    ...
                    <div class="ps-widget__content">
                      <ul>
                        <li class="active">
                          <a href="#"><i class="icon-user"></i> Mi cuenta</a>
                        </li>
                        <li><a href="<?=SERVERURL?>tienda/notificaciones/"><i class="icon-alarm-ringing"></i> Notificaciones</a></li>
                        <li><a href="<?=SERVERURL?>tienda/pedidos/"><i class="icon-papers"></i> Pedidos</a></li>
            ...
            <div class="col-lg-8">
              <div class="ps-section__right">
                <form class="ps-form--account-setting" id="enviar_datos" name='enviar_datos'>
                  ...
                  <div class="form-group submit">
                    <button type='submit' class="ps-btn">Actualizar</button>
                  </div>
                </form>
              </div>
              <div class="ps-section__right">
                <form class="ps-form--account-setting" id="enviar_documento" name='enviar_documento'>
                  <div class="ps-form__header">
                    <h3>Documento Personal</h3>
                  </div>
                  <div class="ps-form__content">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <input type="hidden"   value='<?=$cliente["ID_CLIENTE"]?>' name='id'>
                          ...
                          <select class="form-control" name='documento'>
                              <?php
                                $documentos = $this->listar_documento;
                                foreach($documentos as $doc){

                                  if($cliente["ID_DOCUMENTO"]==$doc['ID_DOCUMENTO']){
                              ?>
                                  <option value="<?=$doc['ID_DOCUMENTO']?>" selected='selected'><?=$doc['DOCUMENTO']?></option>
                                  <?php
                                  }else{
                                    ?>
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input class="form-control" type="text" placeholder="Por favor introduce tu nro de documento..." value='<?=$cliente["N_DOCUMENTO"]?>' name='nro'>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="ps-section__right">
                <form class="ps-form--account-setting" id="enviar_password" name='enviar_password'>
                  <div class="ps-form__header">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input class="form-control" type="password" placeholder="Por favor introduce la password..."  id='password' name='password'>
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label>Actual contraseña</label>
                          <input class="form-control" type="password" placeholder="Por favor introduce la password..."  id='password_2' name='password_2'>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="ps-section__right">
                <form class="ps-form--account-setting" id="enviar_pefil" name='enviar_pefil'>
                  <div class="ps-form__header">
