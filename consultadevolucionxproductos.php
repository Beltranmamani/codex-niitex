...
<head>
    ...
    <title><?=SISTEMA_NOMBRE;?> - Productos devolvidos </title>
...
/* ========================================================================== */
        ...
        $(document).ready(function(){
            ...
            multiCheck(c2);
            $("#view_preventa, #vista_productos_prevendidos,#dp_reporte_preventa").addClass("active");
        ...
        $("#btn_consultar").click(function(){
            ...
            if(fecha_1.length <1 || fecha_2.length <1){
                ...
                if(fecha_2<fecha_1 || fecha_1>fecha_2){
                    ...
                    $.post("<?=SERVERURL;?>preventa/productos_prevendidos_devueltos/",{fecha_1,fecha_2,sucursal},function(response){
