...
<body class="fixed-bottom-padding">
    ...
    <div class="osahan-signup">
        ...
        <div class="p-3">
            <h2 class="my-0">Listo para empezar?</h2>
            <p>Crea una cuenta para comenzar!</p>
            <form id="register-form">
                <div class="form-group">
                    <label for="exampleInputEmail1">Email</label>
                    <input placeholder="Introduce Email" id="correo_reg" type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword1">Password</label>
                    <input placeholder="Introduce Password" id="pass_reg" type="password" class="form-control" id="exampleInputPassword1">
                </div>
                <button id="btn_reg" type="submit" class="btn btn-success rounded btn-lg btn-block">Crear cuenta</button>
            </form>
        </div>
    </div>

    <div class="osahan-fotter fixed-bottom">
        <a href="<?=SERVERURL?>tienda/login/" class="btn btn-block btn-lg bg-white">Ya tienes una cuenta? Iniciar sesion</a>
    </div>
    <nav id="main-nav">
        <ul class="second-nav">
    ...
    <script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js" data-cf-settings="8f7fc7f1ce704563e2dd706c-|49" defer=""></script>
    <script>
      let carrito = {};
