...
<head>
    ...
    <title><?=SISTEMA_NOMBRE;?> - Cotizaciones por vendedores </title>
                    ...
                    <div class="col-12" >
                        <div class="page-header mb-3">
                            <div class="page-title">
                                <h3>Cotizaciones por vendedores</h3>
                            </div>
                        </div>
...
/* ========================================================================== */
        ...
        $(document).ready(function(){
            ...
            multiCheck(c2);
            $("#view_cotizacion, #vista_cotizacion_vendedores,#dp_reporte_cotizacion").addClass("active");
        ...
        $("#btn_consultar").click(function(){
            ...
            if(fecha_1.length <1 || fecha_2.length <1){
                ...
                if(fecha_2<fecha_1 || fecha_1>fecha_2){
                    ...
                    $.post("<?=SERVERURL;?>cotizacion/productos_cotizados_4/",{fecha_1,fecha_2,sucursal},function(response){
