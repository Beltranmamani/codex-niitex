...
<head>
    ...
    <title><?=SISTEMA_NOMBRE;?> - Compras por detalle </title>
...
<body class="alt-menu sidebar-noneoverflow">
    ...
    <script>
        $(document).ready(function(){
            ...
            $("#view_compras, #vista_compras_detalle ,#dp_compras").addClass("active");
        });
        ...
        let mytable = function(){
            ...
            c2 = $('#table_compras').DataTable({
                ...
                buttons: {
                    buttons: [
                        { 
                            ...
                            extend: 'pdfHtml5', 
                            title : "REPORTE DE COMPRAS DETALLADAS - <?=$_SESSION["nombre_sucursal"]?> - <?=date('Y-m-d H:i:s')?>",
                            className: 'btn',
                ...
                "footerCallback": function ( row, data, start, end, display ) {
                    ...
                    $(api.column(4).footer()).html("Total <?=$_SESSION["moneda"]?>");
                ...
                "oLanguage": {
                    ...
                    "sZeroRecords": "No hay registros compras, seleccione un rango de fechas.",
        ...
        $("#btn_consultar").click(function(){
            ...
            if(fecha_1.length <1 || fecha_2.length <1){
                ...
                if(fecha_2<fecha_1 || fecha_1>fecha_2){
                    ...
                    $.post("<?=SERVERURL;?>compras/reporte_compras_detalle/",{fecha_1,fecha_2,sucursal},function(response){
                        if(response == 0){
                            Snackbar.show({
