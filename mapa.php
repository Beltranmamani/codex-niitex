...
<body class="alt-menu sidebar-noneoverflow" id="precessing">
    ...
    <div class="main-container" id="container">
        ...
        <div id="content" class="main-content">
            <div class="layout-px-spacing mt-4">
                <h3>UBICACION DE ENTREGA PARA PREVENTA # <?=$this->preventa['N_PREVENTA']?></h3>
    ...
    <script>
        ...
        L.marker([<?=$this->preventa['L1']?>,<?=$this->preventa['L2']?>]).addTo(mymap)
                    .bindPopup("<b>DESTINARIO: "+'<?=$this->preventa['DESTINO']?>'+" </b> <br />Direccion:"+'<?=$this->preventa['DIRECCION_FISICA']?>'+" <br />Preventa: "+'<?=$this->preventa['N_PREVENTA']?>'+" <br />").openPopup();
