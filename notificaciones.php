...
<html lang="es">
  <head>
    ...
    <title><?=SISTEMA_NOMBRE?> - Notificaciones</title>
  ...
  <body>
                  ...
                  <aside class="ps-widget--account-dashboard">
                    ...
                    <div class="ps-widget__content">
                      <ul>
                        ...
                        <li class="active"><a href="#"><i class="icon-alarm-ringing"></i> Notificaciones</a></li>
    ...
    <script>
        ...
        let lista_de_pedidos = () =>{
          let id_usuario = "<?=$_SESSION['usuario']?>";;
          $.post("<?=SERVERURL?>tienda/notificaciones_cliente/",{id_usuario},function(res){
            $("#tr_cliente").html(res);
          });
        }
