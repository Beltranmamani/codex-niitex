...
<html lang="es">
  <head>
    ...
    <title><?=SISTEMA_NOMBRE?> - Direcciones</title>
                  ...
                  <aside class="ps-widget--account-dashboard">
                    ...
                    <div class="ps-widget__content">
                      <ul>
                        ...
                        <li class="active"><a href="#"><i class="icon-map-marker"></i> Direcciones</a></li>
            ...
            <div class="col-lg-8">
                <div class="ps-section--account-setting">
                    ...
                    <div class="ps-section__content">
                        <button class="btn btn-warning mb-4 btn-block btn-lg p-3" data-toggle="modal" data-target="#modal_direccion">Agregar Dirección</button>
                        <div class="modal fade" id="modal_direccion" tabindex="-1" role="dialog" aria-labelledby="modal_direccion" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <form class="modal-content" name='save' id='save'>
                                    <div class="modal-body">
                                        <div class="form-group">
                                        <input type="hidden"   value='<?=$cliente["ID_CLIENTE"]?>' name='id'>
                                            <label for="direccion">Direccion</label>
                                            <input type="text" class="form-control" name="direccion" id="direccion" placeholder="Nueva dirección">
                                        </div>
                        ...
                        <div class="modal fade" id="modal_editar_direccion" tabindex="-1" role="dialog" aria-labelledby="modal_editar_direccion" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <form class="modal-content" name='update' id='update'>
                                    <div class="modal-body" id='modal_direccion_detalle'>
    ...
    <script>
        ...
        $(document).on('submit','#update',function(e){
          ...
          if(dir.length<=1){
            ...
            var Form = new FormData(document.forms.namedItem("update"));
            $.ajax({
