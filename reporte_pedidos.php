<?php
    ...
    $nombre_pagina = "Reporte de pedidos";
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title><?=SISTEMA_NOMBRE?> - Reporte de pedidos</title>
...
<body class="alt-menu sidebar-noneoverflow">
    ...
    <script>
        $(document).ready(function() {
            $("#view_tienda, #vista_pedidos_reporte").addClass("active");
            App.init();
        ...
        let lista_pedidos = ()=>{
            ...
            let estado = 0;
            $.post("<?=SERVERURL?>pedidostienda/reportepedidos/",{token},function(res){
                    ...
                    buttons: {
                        buttons: [
                            { 
                                ...
                                extend: 'pdfHtml5', 
                                title : "REPORTE DE PEDIDOS ANULADOS - <?=$_SESSION["nombre_sucursal"]?> - <?=date('Y-m-d H:i:s')?>",
                                className: 'btn',
        ...
        $(document).on('click','#btn_consultar',function(){
            ...
            if(fecha_1.length <1 || fecha_2.length <1){
                ...
                if(fecha_2<fecha_1 || fecha_1>fecha_2){
                    ...
                    $.post("<?=SERVERURL;?>pedidostienda/reportepedidos_fecha/",{fecha_1,fecha_2},function(response){
                        let table = $('#tb_compras').DataTable();
                        table.destroy();
