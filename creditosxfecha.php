...
<head>
    ...
    <title><?=SISTEMA_NOMBRE;?> - Creditos por fecha</title>
...
<body class="alt-menu sidebar-noneoverflow">
    ...
    <script>
        $(document).ready(function(){
            $("#view_compras, #vista_credito_fecha, #dp_creditos").addClass("active");
        ...
        $(document).on('click','#btn_consultar',function(){
            ...
            if(fecha_1.length <1 || fecha_2.length <1){
                ...
                if(fecha_2<fecha_1 || fecha_1>fecha_2){
                    ...
                    $.post("<?=SERVERURL;?>compras/reporte_creditos_fecha/",{sucursal,fecha_1,fecha_2},function(response){            
                        if(response == 0){
                            Snackbar.show({
