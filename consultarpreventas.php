...
<head>
    ...
    <title><?= SISTEMA_NOMBRE; ?> - Consulta Preventas </title>
...
">
    ...
    <script>
        ...
        let mytable = function() {
            ...
            $.post("<?= SERVERURL; ?>preventa/lista_preventas/", {
                sucursal
            }, function(response) {
                if (response == 0) {
                    Snackbar.show({
    ...
    <script>
        ...
        $("#btn_consultar").click(function() {
            ...
            if (fecha_1.length < 1 || fecha_2.length < 1) {
                ...
                if (fecha_2 < fecha_1 || fecha_1 > fecha_2) {
                    ...
                    $.post("<?= SERVERURL; ?>preventa/lista_preventa_fecha/", {
                        fecha_1,
                        fecha_2,
                        sucursal
                    }, function(response) {
        ...
        $(document).on('click', '#btn_enviar', function() {
            ...
            window.open("https://wa.me/" + codigo + telefono + "?text=Revise%20su%preventa%20en%20este%20enlace%20" + url)
        })
    </script>
</body>
