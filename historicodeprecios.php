...
<head>
    ...
    <title><?=SISTEMA_NOMBRE;?> - Historico de precios </title>
...
<body class="alt-menu sidebar-noneoverflow">
    ...
    <script>
        $(document).ready(function(){
            $("#view_compras, #vista_historico_precios").addClass("active");
...
/* ========================================================================== */
        ...
        $("#producto").change(function(){
            ...
            $.post("<?=SERVERURL;?>compras/lista_historico_precios_producto/",{producto,sucursal},function(response){            
                if(response == 0){
                    Snackbar.show({
                    ...
                    Snackbar.show({
                        text: 'No hay registros de historixos',
                        actionTextColor: '#fff',
                        backgroundColor: '#e7515a',
                        pos: 'top-right'
                    });
