  ...
  <body>
    ...
    <div class="ps-breadcrumb">
      <div class="ps-container">
        <ul class="breadcrumb">
          <li><a href="<?=SERVERURL?>tienda/online/1">Inicio</a></li>
          <li>Categoria</li>
          ...
          <div class="ps-layout__right">
            <div class="ps-shopping ps-tab-root">
              <div class="ps-shopping__header">
                <p><strong> <?=$this->nro_productos?></strong> Productos encontrados en la categoría <strong>"<?=$this->categoria?>"</strong></p>
            ...
            <div class="ps-product__header">
              <div class="ps-product__thumbnail" data-vertical="false">
                <div class="ps-product__images" data-arrow="true">
                  <div class="item"><img src="<?=SERVERURL?>view/tienda/assets/img/products/detail/fullwidth/1.jpg" alt=""></div>
                  <div class="item"><img src="<?=SERVERURL?>view/tienda/assets/img/products/detail/fullwidth/2.jpg" alt=""></div>
                  <div class="item"><img src="<?=SERVERURL?>view/tienda/assets/img/products/detail/fullwidth/3.jpg" alt=""></div>
                </div>
              </div>
