...
<head>
    ...
    <title><?= SISTEMA_NOMBRE; ?> - Preventas por fecha </title>
...
<body class="alt-menu sidebar-noneoverflow">
    ...
    <script>
        $(document).ready(function() {
            $("#view_preventa, #vista_preventa_fecha,#dp_reporte_preventa").addClass("active");
            c2 = $('#table_compras').DataTable({
                ...
                buttons: {
                    buttons: [{
                        ...
                        extend: 'pdfHtml5',
                        title: "REPORTE DE PREVENTA - <?= $_SESSION["nombre_sucursal"] ?> - <?= date('Y-m-d H:i:s') ?>",
                        className: 'btn',
    ...
    <script>
        /* ========================================================================== */
        /*                     funcion consultar Preventa por fecha                    */
        /* ========================================================================== */
        ...
        $("#btn_consultar").click(function() {
            ...
            if (fecha_1.length < 1 || fecha_2.length < 1) {
                ...
                if (fecha_2 < fecha_1 || fecha_1 > fecha_2) {
                    ...
                    $.post("<?= SERVERURL; ?>preventa/reporte_preventa_fecha/", {
                        fecha_1,
                        fecha_2,
                        sucursal
                    }, function(response) {
        ...
        /* ========================================================================== */
        /*           Funcion capturar {id} de preventa para ver el detalle            */
        /* ========================================================================== */
