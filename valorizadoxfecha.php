...
<head>
    ...
    <title><?=SISTEMA_NOMBRE;?> - Kardex valorizado por fecha</title>
            ...
            if(vendedor == null){
                ...
                if(fecha_1.length <1 || fecha_2.length <1){
                    ...
                    if(fecha_2<fecha_1 || fecha_1>fecha_2){
                        ...
                        $.post("<?=SERVERURL;?>kardex/kardex_valorizado_vendedor/",{vendedor,sucursal,fecha_1,fecha_2},function(response){            
                            if(response == 0){
                                Snackbar.show({
