...
<head>
    ...
    <title><?=SISTEMA_NOMBRE;?> - Traspaso de productos </title>
                            ...
                            <div class="col-12">
                                <div class="row m-2">
                                    ...
                                    <div class="col-sm-12 col-md-8 ">
                                        <button class="btn btn-success mb-4 mr-2 btn-lg btn-block" onclick="procesar_venta()">
        ...
        <div class="modal-dialog modal-dialog-centered " role="document">
            <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                <label for="cliente">Sucursal</label>
                                <select class="form-control  basic" id="sucursal">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success" id='btntransferir'>
...
/* ========================================================================== */
        $(document).ready(function(){
            $("#view_inventario ,#vista_nuevo_traspaso").addClass("active");
                ...
                if(respuesta != ""){
                    ...
                    let templeate = `
                        <div class="alert alert-arrow-right alert-icon-right alert-light-info mb-4" role="alert" style="width: 90%;height: 50px;margin: auto;margin-top: 10px;">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-archive"><polyline points="21 8 21 21 3 21 3 8"></polyline><rect x="1" y="3" width="22" height="5"></rect><line x1="10" y1="12" x2="14" y2="12"></line></svg>
                            <strong>SIN STOCK!</strong> No hay productos en esa presentaci��n.
                        </div>
                    `;
...
/* ========================================================================== */
        ...
        $(document).on('click','.btn_agregar',function(){
            ...
            if(document.getElementById("item_list"+id_item)){
                ...
                let id_lote = $("#item_"+id_item).attr('id_lote');
                ...
                htmlproducto(id_item,articulo,1,precio,descuento,total.toFixed(2),linea,stock,exento,producto,almacen,id_lote,lote);
            }
        });
...
/* ========================================================================== */
        ...
        let htmlproducto=function(id_item,articulo,cantidad,precio,descuento,total,linea,stock,exento,producto,almacen,id_lote,lote){
            let tr = "\
                <tr id='item_list"+id_item+"' class='items_tr' id_item='"+id_item+"' id_lote='"+id_lote+"' lote='"+lote+"' stock='"+stock+"' exento='"+exento+"' producto='"+producto+"' almacen='"+almacen+"'>\
                    <td>"+articulo+" | <span style='color: #03a9f4;font-weight: 600;'>"+linea+"</span></td>\
                    <td><input id='"+id_item+"_carrito_cantidad' type='text' value='"+cantidad+"'></td>\
                    <td><input id='"+id_item+"_carrito_precio' type='text' value='"+precio+"'></td>\
                    <td><input id='"+id_item+"_carrito_descuento' type='text' value='"+descuento+"'></td>\
                    <td id='precio_item_total_"+id_item+"'>"+total+"</td>\
            ...
            $("#"+id_item+"_carrito_descuento").TouchSpin({
                min: 0,
                max : 100,
                step:0.1,
                decimals:2
            });
            $("#"+id_item+"_carrito_precio").TouchSpin({
                min: 0,
                max : 999999999999999,
                step:0.1,
                decimals:2
            });
            $("#"+id_item+"_carrito_cantidad").TouchSpin({
                min:0,
                max:stock
            });
...
/* ========================================================================== */
/*             Detectar el aumento de cantidad, precio y descuento            */
/* ========================================================================== */
...
/* ========================================================================== */
/*              Detetcar la resta de cantidad, precio y descuento             */
/* ========================================================================== */
...
/* ========================================================================== */
        function procesar_venta (){
            ...
            if(items < 1){
                Snackbar.show({
                    text: 'No hay producto para proceder con el traspaso',
                    actionTextColor: '#fff',
                    backgroundColor: '#e91e63',
                    pos: 'top-right'
                });
                ...
                $('#modal_procesar_traspaso').modal('show');
            }
        }
...
/* ========================================================================== */
        ...
        $("#btntransferir").click(function(){
            ...
            if(almacen == null || almacen.length <=0){
                ...
                return false;
            }else if(motivo == null || motivo.length <=0){
                Snackbar.show({
                    text: 'El motivo es necesario',
                    actionTextColor: '#fff',
                    backgroundColor: '#e7515a',
                    pos: 'top-right'
                });
                ...
                var block = $("#container");
                $(block).block({ 
                    message: '<span class="text-semibold"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-loader spin position-left"><line x1="12" y1="2" x2="12" y2="6"></line><line x1="12" y1="18" x2="12" y2="22"></line><line x1="4.93" y1="4.93" x2="7.76" y2="7.76"></line><line x1="16.24" y1="16.24" x2="19.07" y2="19.07"></line><line x1="2" y1="12" x2="6" y2="12"></line><line x1="18" y1="12" x2="22" y2="12"></line><line x1="4.93" y1="19.07" x2="7.76" y2="16.24"></line><line x1="16.24" y1="7.76" x2="19.07" y2="4.93"></line></svg></i>&nbsp; Traspasando productos...</span>',
                    overlayCSS: {
                        backgroundColor: '#fff',
                        opacity: 0.8,
                        cursor: 'wait'
                ...
                $.post("<?=SERVERURL?>inventario/agregar_traspaso/",{
                    almacen,motivo,productos,sucursal,usuario
                },function(response){
                    if(response == 2){
                        Snackbar.show({
                            text: 'Hubo un problema para guardar la preventa',
                            actionTextColor: '#fff',
                            backgroundColor: '#e7515a',
                            pos: 'top-right'
                        });
                        ...
                        if(resd[0]== 1){
                            ...
                            $("#formato_a4").attr('href',"<?=SERVERURL;?>inventario/formatoA4/"+resd[1]);
                            $("#formato_a5").attr('href',"<?=SERVERURL;?>inventario/formatoA5/"+resd[1]);
...
/* ========================================================================== */
        ...
        const lista_productos_carrito = ()=>{
            ...
            for (i = 1; i < items + 1; i++){
                ...
                let almacen = $('#body_productos .items_tr:nth-child('+i+')').attr('almacen');
                let stock = $('#body_productos .items_tr:nth-child('+i+')').attr('stock');
                let producto = $('#body_productos .items_tr:nth-child('+i+')').attr('producto');
                let id_lote = $('#body_productos .items_tr:nth-child('+i+')').attr('id_lote');
                let lote = $('#body_productos .items_tr:nth-child('+i+')').attr('lote');
                let cantidad = $("#"+id_item+"_carrito_cantidad").val();
                let precio = $("#"+id_item+"_carrito_precio").val();
                let descuento = $("#"+id_item+"_carrito_descuento").val();
                let subtotal_producto = 0;
                precio = parseFloat(precio);
                subtotal_producto = parseFloat(cantidad*precio);
                descuento = parseFloat(subtotal_producto*descuento/100);
                let total_producto = parseFloat(subtotal_producto-descuento);
                data += id_item+'|'+almacen+'|'+cantidad+'|'+descuento+'|'+precio+'|'+subtotal_producto+'|'+total_producto+'|'+stock+'|'+producto+'|'+id_lote+'|'+lote+',';
            };
            return data;
        }
...
/* ========================================================================== */
        ...
        $(document).on('change','#sucursal',function(){
            ...
            $.post("<?=SERVERURL;?>inventario/listaralmacenes/",{idsucursal},function(res){
                if(res==0){
                    Snackbar.show({
                        text: 'No se pudo cargar almacenes',
                        actionTextColor: '#fff',
                        backgroundColor: '#e7515a',
                        pos: 'top-right'
                    });
